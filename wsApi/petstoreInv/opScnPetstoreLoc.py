...
# -*- coding: utf-8 -*-
"""\
*    *[Summary]* :: A =WsIcmInvoker=: Given a swagger Service Specification, make all operations invokable from command line.
"""

####+BEGIN: bx:icm:python:top-of-file :partof "bystar" :copyleft "none"
"""
*  This file:/bisos/git/bxRepos/roPerf-pip/petstoreExample/wsApi/petstoreInv/opScnPetstore.py :: [[elisp:(org-cycle)][| ]]
...
__icmName__ = "opScnPetstore"
####+END:

####+BEGIN: bx:global:timestamp:version-py :style "date"
__version__ = "201908132822"
####+END:
...
from unisos.mmwsIcm import mmwsIcmPkgThis
...
####+END:
        ...
        svcSpecFile="../svcSpec/petstoreSvc-api.json"        
